...
import com.ex.board3.BoardService;
...
public class BoardController {
	...
	public String process(Locale locale, Model model, 
		...
		try {
			dao.save(new BoardVo(title, writer, content, 0));
		} catch (Exception e) {
	...
	public String process(Locale locale, Model model, 
		...
		try {
			dao.save(new BoardVo(id, title, writer, content, 0));
		} catch (Exception e) {
			return processError(model, e);
		}
